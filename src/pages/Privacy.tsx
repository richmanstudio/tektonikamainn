...
const privacyCopy: Record<Lang, PrivacyCopy> = {
  ru: {
    lead:
      "Настоящая Политика конфиденциальности и обработки персональных данных определяет порядок обработки данных пользователей сайта ООО «ТЕКТОНИКА». Документ подготовлен для публичного размещения на сайте и применяется к формам обратной связи, техническим данным браузера, cookies/localStorage и иным сведениям, которые пользователь передает при использовании сайта.",
